	...
	<div class="authtication bluesh high-opacity">
		...
		<ul class="welcome-caro">
			...
			<li class="welcome-box">
				...
				<p>
					Join JOBROOM and make your network of university or college fellows.
				</p>
			</li>
			<li class="welcome-box">
				...
				<p>
					Sell your online lectures, videos, books and many more with JOBROOM.
				</p>
			</li>
	...
	<div class="auth-login">
		...
		<div class="verticle-center">
			<div class="login-form">
				...
				<form method="post" action="admin/functions/login_preson.php" class="c-form">
					...
					<div>
						<br>
					<a href="signup.php">Sign UP User ?</a>
					<br>
					<br>
					<a href="sign-up-company.php">Sign UP company ?</a>
					</div>
				</form>

	...
	<div class="auth-login">
		<div class="verticle-center">
			<div class="signup-form">
				...
				<form method="post" class="c-form" action="admin/functions/add_person.php">
					...
					<div class="row merged-10">
						...
						<div class="col-lg-6 col-sm-6 col-md-6">
							<input type="date" name = "age" placeholder="birthday" require>
						</div>
						<div class="col-lg-6 col-sm-6 col-md-6">
						...
						<?php 
							$select = $connect ->query("SELECT * FROM person_degree");
							foreach ($select as $row) {
								
							
						?>
						<div class="col-lg-6 col-sm-6 col-md-6">
							<input type="radio"  name="degree" value="<?php echo $row['id'] ?>" >
							<label ><?php echo $row['name'] ?></label>
						</div>
						<?php }?>
						<div class="col-lg-6 col-sm-6 col-md-6">
							<input type="text" name="university" placeholder="Institute, University" require>
						</div>
						<div class="col-lg-6 col-sm-6 col-md-6">
							<input type="text"  name="department" placeholder="Department" require>
						</div>
						<div class="col-lg-12">
